...
namespace ofplug.Mapping
{
	public static class Subscription
	{
		...
		public static List<string> Needs_update_in_crm(crm.Abonnement crm_abonnement, of.data.Subscription of_subscription)
		{
			...
			Mapping_update_helper.Add_if_unequal(parameters, "nrq_of_subscription_id", crm_abonnement.Nrq_of_subscription_id, of_subscription.Of_id);
			Mapping_update_helper.Add_if_unequal(parameters, "nrq_order_id", crm_abonnement.Nrq_order_id, of_subscription.Order_id);
			Mapping_update_helper.Add_if_unequal(parameters, "nrq_payment_gateway", crm_abonnement.Nrq_payment_gateway, of_subscription.Payment_gateway);
			Mapping_update_helper.Add_if_unequal(parameters, "nrq_payment_media", crm_abonnement.Nrq_payment_media, of_subscription.Payment_media);
